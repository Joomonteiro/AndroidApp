...
import 'package:pets_app/PetViewMapper.dart';
  ...
  _getPets() {
    API.getPets().then((response) {
      setState(() {
        ...
        print(pets);
        // tentei criar um map 
        // PetViewMapper petViewMapper;
        // petsView = petViewMapper.converte(pets);
      });
    });
  }
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            listaPetsView[imgIndex].name + " | " + listaPetsView[imgIndex].price.toString() + " | likes: " + listaPetsView[imgIndex].foodsLike +" | dislikes: " + listaPetsView[imgIndex].foodsDislikes,
